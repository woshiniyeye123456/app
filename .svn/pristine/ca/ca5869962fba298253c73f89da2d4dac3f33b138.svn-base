  ...
  <div id="dangerData">
    ...
    <div class="dangerData_chartBox">
      ...
      <div class="chartBox_thirdChart">
        ...
        <ul class="dangerData_bottomList">
...
export default class dangerData extends Vue {
  private tableArr = [];
           ...
           if(resData.status =='200'){
             ...
             _this.topList.forEach((item,index)=>{
               if(item.name.indexOf('企业')>=0){
                 item.num=item.num+"家";
               }else if(item.name.indexOf('危险源')>=0||item.name.indexOf('设备')>=0){
                 item.num=item.num+"个";
