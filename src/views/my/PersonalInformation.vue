<template>
   <div id="personalInformation">
     ...
     <mytitle :title="title" :showRight="false" :isNotRoute="true" :whetherNotParent="false" @close="GoBack" ></mytitle>
     <!--头像-->
     ...
     <mt-cell class="listBox"  @click.native="changeInformationPage('name')" title="姓名" >{{user.name}}
     ...
     <mt-cell class="listBox" @click.native="changeInformationPage('notes')" title="备注" value="兼职人员">
